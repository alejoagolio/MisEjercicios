window.onload = function()
{
	...
	var vs_source = document.getElementById("vertexShader").text;
	var fs_source = document.getElementById("fragmentShader").text;
	...
	// Verifico que el shader se haya compilado correctamente
